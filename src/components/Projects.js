    ...
    return (
        <section id="projects">
            ...
            <div className="mt-15 mx-4 flex flex-wrap justify-center">
                ...
                <div className="mt-20 mx-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <a href="#">
                    ...
                    <div className="p-5">
                        ...
                        <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-black rounded-lg">
                            Read more
